...
configurations = {
    "plani_proc": {
        "Kernel": {"sheduler_algorithm": "FIFO", "quantum": 875},
        "Memoria": {
            "memory_size": 1024,
            "response_delay": 500,
            "scheme": "FIJAS",
    ...
    "recurso_mutex": {
        "Kernel": {"sheduler_algorithm": "CMN", "quantum": 750},
        "Memoria": {
            "memory_size": 1024,
            "response_delay": 200,
            "scheme": "FIJAS",
    ...
    "prueba_fs": {
        "Kernel": {"sheduler_algorithm": "CMN", "quantum": 25},
        "Memoria": {
            "memory_size": 2048,
            "response_delay": 10,
            "scheme": "DINAMICAS",
    ...
    "the_emptiness_machine": {
        "Kernel": {"sheduler_algorithm": "CMN", "quantum": 125},
        "Memoria": {
            "memory_size": 8192,
            "response_delay": 50,
            "scheme": "DINAMICAS",
